...
def zad2_two_layer_net(student_id):
    ...
    class SimpleTwoLayerNetwork:
        ...
        def forward(self, x_data):
            # TODO ----------------------------------------------------------------------
            h_out = self.hidden_layer.forward(x_data)   # [batch_size, n_hidden]
            result = self.output_layer.forward(h_out)   # [batch_size, n_out]
            return result
...
if __name__ == '__main__':
    ...
    student_id = 197584         # Twój numer indeksu, np. 102247
